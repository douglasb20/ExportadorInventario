...
namespace ExportadorInventario
{
    static class Funcoes
    {
        ...
        {
            return MessageBox.Show(text, ConfigReader.titulo, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        public static DialogResult ChamaAlerta(string texto = "", string tipo = "info")
        {
            ...
            {
                case "question":
                    resultado = MessageBox.Show(texto, ConfigReader.titulo, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    break;
                case "warning":
                    resultado = MessageBox.Show(texto, ConfigReader.titulo, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    break;
                case "error":
                    resultado = MessageBox.Show(texto, ConfigReader.titulo, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
                default:
                    resultado = MessageBox.Show(texto, ConfigReader.titulo, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    break;
            }
